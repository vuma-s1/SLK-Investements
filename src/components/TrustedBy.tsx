    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
             ...
             <span className="w-2 h-2 bg-[#24525c] rounded-full"></span>
            ...
            <div key={index} className="group">
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-1">
                <div className="flex items-center gap-4">
                                     <div className="w-12 h-12 bg-[#24525c] rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                    {stat.icon}
                  </div>
                  <div>
        ...
        >
          {companies.map((company, index) => (
            <div key={index} className="group marquee-item flex-shrink-0 px-3 md:px-6">
              <div className="text-center">
                                                  <h4 className="font-bold text-black text-sm md:text-base mb-1">{company.logo}</h4>
                 <h4 className="font-semibold text-black text-xs md:text-sm mb-1">{company.name}</h4>
